(function (global, factory) {
...
}(typeof self !== 'undefined' ? self : this, function (exports,React) { 'use strict';
	...
	*/
	...
	var getMaxWindowScroll = (function () {
	  ...
	  !doc ? invariant(false, 'Cannot get max scroll without a document') : void 0;
	  var maxScroll = getMaxScroll({
	...
	var getViewport = (function () {
	  ...
	  var left = scroll.x;
	  var doc = document.documentElement;
	  !doc ? invariant(false, 'Could not find document.documentElement') : void 0;
	...
	var getBody = function getBody() {
	  !document.body ? invariant(false, 'Announcer cannot find document.body') : void 0;
	...
	*/
	...
	var throwIfRefIsInvalid = (function (ref) {
	  !(ref && ref instanceof HTMLElement) ? invariant(false, "\n    provided.innerRef has not been provided with a HTMLElement.\n\n    You can find a guide on using the innerRef callback functions at:\n    https://github.com/atlassian/react-beautiful-dnd/blob/master/docs/guides/using-inner-ref.md\n  ") : void 0;
	});
	...
	var getDragHandleRef = function getDragHandleRef(draggableRef) {
	  ...
	  !(el instanceof HTMLElement) ? invariant(false, 'A drag handle must be a HTMLElement') : void 0;
	  return el;
	};
